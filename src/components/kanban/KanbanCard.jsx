...
import { Bug, Lightbulb, CheckSquare, AlertTriangle, Clock, ArrowUp, ArrowDown, Hash, User } from "lucide-react";
...
export default function KanbanCard({ task, provided, isDragging }) {
  ...
  return (
    <div
      ...
      className={cn(
        "group relative rounded-xl border border-white/[0.06] p-4 mb-2.5",
        "bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-sm",
        "hover:border-white/[0.12] hover:from-slate-800 hover:to-slate-850",
